...
    return (
        <Box sx={{ py: 8, px: 2, minHeight: '100%', background: 'white', borderRadius: 2, boxShadow: 3 }}>
...
                >
                    FileFlowz คือระบบจัดการสื่อดิจิทัล (DAM) และ Content Delivery Network (CDN) แบบครบวงจร
                </Typography>
